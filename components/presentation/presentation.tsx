...
export function Presentation() {
  ...
  return <div className="presentation font-sans" ref={root}>
    ...
    <div className="print-deck" aria-hidden="true">{slides.map((slide,i)=><Slide key={slide.kind} index={i} />)}</div>
  </div>;
}
